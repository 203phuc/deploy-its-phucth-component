...
export const trackCva = cva(
  'relative inline-flex items-center transition-colors duration-300 select-none hover:outline hover:outline-1 hover:outline-black',
  {
    variants: {
      size: {
