...
export const EyeCloseIcon = ({ color = '#2C2C2C', size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <line
      ...
      strokeLinecap="round"
    />
    <path d="M14.3795 10.999L15.3386 16.0162" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
    <path d="M18.6738 8.99609L20.9769 13.3761" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
